                   ...
                   if(Input.touchCount == 1)
						{
							...
							if (theTouch.phase == TouchPhase.Began) 
         					...
         					if (theTouch.phase == TouchPhase.Moved) 
         					{
         						...
         						var rotationOfObject : float = targetItem.transform.eulerAngles.y - theTouch.deltaPosition.x;
          		        		//targetItem.transform.Rotate(theTouch.deltaPosition.y * rotationRate, -theTouch.deltaPosition.x * rotationRate,0,Space.World);
          		        		/*Debug.Log("Rotation of Object = " + rotationOfObject);*/
          		        		targetItem.transform.Rotate(0, -theTouch.deltaPosition.x * rotationRate,0,Space.World);
          		        		/*if(rotationOfObject > 96 && rotationOfObject < 335){
          		        		  targetItem.transform.Rotate(0, -theTouch.deltaPosition.x * rotationRate,0,Space.World);
          		        		  var scaleOfObject : float = -theTouch.deltaPosition.x/16000;
          		        		 targetItem.transform.localScale += Vector3(scaleOfObject,scaleOfObject,scaleOfObject);
          		        		}*/
         					...
         					{
         					    /*var rotationOfObject2 : float = targetItem.transform.eulerAngles.y;
         					     Debug.Log("Rotation " + rotationOfObject2);*/
  ...
  /*  if(Input.touchCount == 0 )
    {
                ...
                if(rotateVelocityX != 0.0f || rotateVelocityY != 0.0f)
         	{
         		...
         		targetItem.transform.Rotate(0, -XVelocity * Time.deltaTime * rotationRate,0,Space.World);	
